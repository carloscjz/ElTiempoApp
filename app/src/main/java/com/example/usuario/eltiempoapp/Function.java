...
/**
 * Created by Usuario on 10/06/2018.
 */
...
public class Function {
    ...
    private static final String OPEN_WEATHER_MAP_API = "8c217e4c2ecf3e025256d6cb386d2c1b";
    ...
    public static class placeIdTask extends AsyncTask<String, Void, JSONObject> {
        ...
        public AsyncResponse delegate = null;//Llama a la interfaz

        public placeIdTask(AsyncResponse asyncResponse) {
            delegate = asyncResponse;//Asigna una llamada al constructor a traves de la interfaz
        }
